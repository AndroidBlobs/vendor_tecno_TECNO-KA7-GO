...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO = CY-ka7-h8024
...
#add for OTP by wanchao.li 20171220 start
CONFIG_OTP_MANUAL_CONTROL = yes
#add for OTP by wanchao.li 20171220 end
# modify for 3l8 otp by wei.miao@reallytek.com 20180111 start
CUSTOM_HAL_CAM_CAL = s5k3l8_eeprom
# modify for 3l8 otp by wei.miao@reallytek.com 20180111 end
CUSTOM_HAL_COMBO = mt6580
# modify for camera by wei.miao@reallytek.com 20171204 start
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
CUSTOM_HAL_IMGSENSOR = s5k3l8_mipi_raw s5k3l8_st_mipi_raw ov8856_mipi_raw gc8c34_mipi_raw
CUSTOM_HAL_LENS = dw9718saf dw9718sstaf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9718saf dw9718sstaf
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l8_mipi_raw s5k3l8_st_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9718saf dw9718sstaf
# modify for camera by wei.miao@reallytek.com 20171204 end
CUSTOM_HAL_MSENSORLIB =akl
CUSTOM_HAL_SENSORS = sensor
# modify for camera by wei.miao@reallytek.com 20171201 start
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS =
CUSTOM_HAL_SUB_IMGSENSOR = ov8856_mipi_raw gc8c34_mipi_raw
CUSTOM_HAL_SUB_LENS = dummy_lens
# modify for camera by wei.miao@reallytek.com 20171201 end
...
# modify for 3l8 otp by wei.miao@reallytek.com 20180111 start
CUSTOM_KERNEL_CAM_CAL = s5k3l8_eeprom
# modify for 3l8 otp by wei.miao@reallytek.com 20180111 end
CUSTOM_KERNEL_CORE = src
CUSTOM_KERNEL_DCT = dct
CUSTOM_KERNEL_DEVICE_ORIENTATION =
CUSTOM_KERNEL_FLASHLIGHT = constant_flashlight
#add XLLLGOBLES-1 by haiping.bai 20171117 start
CUSTOM_KERNEL_GYROSCOPE = no
#add XLLLGOBLES-1 by haiping.bai 20171117 end
CUSTOM_KERNEL_HDMI =
CUSTOM_KERNEL_HEADSET = accdet
# modify for camera by wei.miao@reallytek.com 20171204 start
CUSTOM_KERNEL_IMGSENSOR = s5k3l8_mipi_raw s5k3l8_st_mipi_raw ov8856_mipi_raw gc8c34_mipi_raw
# modify for camera by wei.miao@reallytek.com 20171204 end
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
# modify for camera by wei.miao@reallytek.com 20171124 start
CUSTOM_KERNEL_LENS = dw9718saf dw9718sstaf dummy_lens
# modify for camera by wei.miao@reallytek.com 20171124 end
CUSTOM_KERNEL_MAGNETOMETER = no
# modify for camera by wei.miao@reallytek.com 20171124 start
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9718saf dw9718sstaf
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l8_mipi_raw s5k3l8_st_mipi_raw
CUSTOM_KERNEL_MAIN_LENS =  dw9718saf dw9718sstaf
# modify for camera by wei.miao@reallytek.com 20171124 end
CUSTOM_KERNEL_MOTION_DETECT =
# add XLLLGOBLES-1 by haiping.bai 20171124 start
CUSTOM_KERNEL_ORIENTATION_SENSOR = no
# add XLLLGOBLES-1 by haiping.bai 20171124 end
CUSTOM_KERNEL_PDR_SENSOR = no
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SSW =
CUSTOM_KERNEL_STATIONARY_SENSOR =
# modify for camera by wei.miao@reallytek.com 20171201 satrt
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_BACKUP_LENS =
CUSTOM_KERNEL_SUB_IMGSENSOR = ov8856_mipi_raw gc8c34_mipi_raw
...
#RD6 add for KAQHBLES-137 multi md image by xiangfu.dang 20180225 start
CUSTOM_MODEM = ka7_h8024_DOWNLINK ka7_h8024_FULLEDGE
#RD6 add for KAQHBLES-137 multi md image by xiangfu.dang 20180225 end
...
#RD6:gaoxuebin add for FONT 20180309 start
LOVELYFONTS_SUPPORT = no
#RD6:gaoxuebin add for FONT 20180309 end
MAXIM_SPEAKER_SUPPORT = no
MD32_TOOLCHAIN_MODULE = IPDesigner/12R2.36-64
MD5_SIZE = 0x01600000
MD5_SMEM_SIZE = 0x00200000
#modify tee by xing.fang 20171121 start
#modify tee KAQHBLES-10 by weifeng.niu 20180125 start
MICROTRUST_TEE_SUPPORT = yes
#modify tee KAQHBLES-10 by weifeng.niu 20180125 end
#modify tee by xing.fang 20171121 end
MNTL_SUPPORT = no
...
#add XLLLGOBLES-1 by xing.fang 20171114 start
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
#add XLLLGOBLES-1 by xing.fang 20171114 end
...
#Infinix: modify dirac by sangui.zhang 20171219 start
#Tecno:yundi modify for KA7 20180226 start
MTK_BESLOUDNESS_SUPPORT = yes
#Tecno:yundi modify for KA7 20180226 end
#Infinix: modify dirac by sangui.zhang 20171219 end
#add XLLLGOBLES-1 by cheng.wang 20171124 start
TRAN_LCM_SUPPORT = yes
#add XLLLGOBLES-1 by cheng.wang 20171124 end
#add XLLLGOBLES-1 by xing.fang 20171114 start
#Infinix: modify dirac by sangui.zhang 20171219 start
#RD6  zhaoxin   modify  for  KAQHBLES-967  begin
#TECNO:yundi add for KA7 start
MTK_BESSURROUND_SUPPORT = no
#TECNO:yundi add for KA7 end
#RD6  zhaoxin   modify  for  KAQHBLES-967  end
#Infinix: modify dirac by sangui.zhang 20171219 end
#add XLLLGOBLES-1 by xing.fang 20171114 end
...
MTK_BUILD_VERNO = KA7-H8024ABC-GO-181012V173
#Tecno:WUHONG  modify for KAQHBLES-166  20180226 start
FINGERPRINT_BUILD_VERNO = ABC-181012V173
#Tecno:WUHONG  modify for KAQHBLES-166 20180226 end
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
MTK_CAMERA_APP = no
#TECNO CameraAP:add CAMERAEYL-128 shiyang.zhang 2018-01-31start
MTK_CAMERA_APP_VERSION = tecnocamera2
#TECNO CameraAP:add CAMERAEYL-128 shiyang.zhang 2018-01-31 end
...
#add by ruijie.zhang KAQHBLES-1503 20180408 start
MTK_DM_VERITY_OFF = yes
#add by ruijie.zhang KAQHBLES-1503 20180408 end
...
#modify XLLLGOBLES-6 by lei.ni 20171204 start
MTK_ENCRYPTION_DEFAULT_OFF = yes
#modify XLLLGOBLES-6 by lei.ni 20171204 end
...
#RD6:wangmeng modify for KAQHBLES-740 2018-03-19 start
MTK_ETWS_SUPPORT = yes
#RD6:wangmeng modify for KAQHBLES-740 2018-03-19 end
...
#add XLLLGOBLES-7 by lei.ni 20171115 start
MTK_FACTORY_MODE_IN_GB2312 = no
#add XLLLGOBLES-7 by lei.ni 20171115 end
...
# XLLLHBLES-27 add by shaojun.zou enable GMO 17/12/15 start
MTK_GMO_RAM_OPTIMIZE = yes
MTK_GMO_ROM_OPTIMIZE = yes
# XLLLHBLES-27 add by shaojun.zou enable GMO 17/12/15 end
...
#Tecno:by wuhong KAQHBLES-827 20180319 start
MTK_LOG_CUSTOMER_SUPPORT = yes
#Tecno:by wuhong KAQHBLES-827 20180319 end
...
# add by LRZ for Project macro configuration 20171110
CUSTOM_TRAN_PROJECT=tran_ka7
CUSTOM_TRAN_BOM=tran_ka7_abc
# add end
...
#add XLLLHBLES-1556 by xing.fang 20180111 start
MTK_PERSIST_PARTITION_SUPPORT = yes
#add XLLLHBLES-1556 by xing.fang 20180111 end
...
#Modify XLLLHBLES-2 by lei.guo2 for modem p1 20171116 start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes
#Modify XLLLHBLES-2 by lei.guo2 for modem p1 20171116 end
...
#add KAQHBLES-1873 by zhangzuochen 20180423 start
MTK_SOUNDRECORDER_APP = yes
#add KAQHBLES-1873 by zhangzuochen 20180423 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
#modify XLLLHBLES-1 by jiaqi.cai 20171124 start
MTK_UART_USB_SWITCH = yes
#modify XLLLHBLES-1 by jiaqi.cai 20171124 end
MTK_UCE_SUPPORT = no
MTK_UFS_BOOTING = no
MTK_UFS_OTP = no
...
#add KAQHBLES-45 for camera 3rd by xiaoxue.cai 20180207 start
TRAN_CAMERA_FEATURE_V1 = yes
TRAN_CAMERA_VISIDON_FACEBEAUTY = no
TRAN_CAMERA_ARCSOFT_BEAUTY = yes
TRAN_CAMERA_FRONT_MIRROR = yes
TRAN_CAMERA_ARCSOFT_SINGLE_FRM_DENOISE = yes
TRAN_CAMERA_ARCSOFT_PANORAMA = yes
TRAN_CAMERA_ARCSOFT_PICSELFIE = yes
TRAN_CAMERA_ARCSOFT_LOWLIGHT = yes
TRAN_CAMERA_ARCSOFT_NIGHTHAWK = yes
TRAN_CAMERA_WATERMARK = yes
#add KAQHBLES-45 for camera 3rd by xiaoxue.cai 20180207 end
#add KAQHBLES-727 KAQHBLES-1096 for camera portraiture by mojl 20180321 start
#TECNO_CAMERA_PORTRAITURE_SIZE = 2560x1920
#add KAQHBLES-727 KAQHBLES-1096 for camera portraiture by mojl 20180321 end
WIFI_WEP_KEY_ID_SET = no
MTK_HIDL_PROCESS_CONSOLIDATION_ENABLED = no
MTK_OVERRIDES_APKS = yes
MTK_QOS_SUPPORT = no
MTK_DIGITS_SUPPORT = no
# Modify by zhaoyang.shi KAQHBLES-2294 20180619 start
# MTK_DEFAULT_WRITE_DISK = no
MTK_DEFAULT_WRITE_DISK = yes
# Modify by zhaoyang.shi KAQHBLES-2294 20180619 end
MTK_ANDROID_FOR_WORK_SUPPORT = no
MTK_SENSORS_1_0 = yes
MTK_SWIP_WMAPRO = no
BUILD_AGO_GMS = no
MTK_NLP_SUPPORT = yes
#add for midtest by caizhaohui 20171123 start
RLK_MIDTEST_SUPPORT = yes
MIDTEST_FLASH_FORWARD_SUPPORTED = yes
MIDTEST_DISTANCE_SENSOR_SUPPORTED = yes
MIDTEST_LIGHT_SENSOR_SUPPORTED = yes
MIDTEST_FINGERPRINTF_SUPPORTED = yes
MIDTEST_FINGER_SW9088_SUPPORTED = yes
MIDTEST_FINGER_MA_TEE_SUPPORTED = yes
MIDTEST_FILL_LIGHT_SUPPORTED = yes
MIDTEST_SIGNAL_SUPPORTED = yes
#add for midtest by caizhaohui 20171123 end

#add by peixuan.qiu for factory reset 20171121 start
TRAN_FT_RESET = yes
#add by peixuan.qiu for factory reset 20171121 end

#add by peixuan.qiu for adb debug reboot  20171121 start
TRAN_FT_REBOOT = yes
#add by peixuan.qiu for adb debug reboot  20171121 end

#add by peixuan.qiu for meta executing shell command 20171122 start
TRAN_FT_CUSTOM_SHELL = yes
#add by peixuan.qiu for meta executing shell command 20171122 end

#add by peixuan.qiu  sim-sd tray detect  20171120 start
TRAN_FT_SIM_SD_TRAY_DETECT = yes
#add by peixuan.qiu  sim-sd tray detect  20171120 end
#add XLLLHBLES-9 by peixuan.qiu for benchflag 20171124 start
TRAN_FT_BENCHFLAG_SUPPORT = yes
#add XLLLHBLES-9 by peixuan.qiu for benchflag 20171124 end

#add XLLLGOBLES-1 by xing.fang 20171122 start
#modify tee KAQHBLES-10 by weifeng.niu 20180125 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee microarray_tee cdfinger_tee
#modify tee KAQHBLES-10 by weifeng.niu 20180125 end
#add XLLLGOBLES-1 by xing.fang 20171122 end

#add XLLLHBLES-13 by haiping.bai 20171201 start
TRAN_AUDIOTEST_SUPPORT = yes
#add XLLLHBLES-13 by haiping.bai 20171201 end
#add XLLLHBLES-9 by gujiacheng 20171201 start
#add KAQHBLES-23 by gaoxuebin 20180206 start
RLK_PROJECT=tecno_ka7
TRANSSION_PRODUCT_DEVICE=Tecno-KA7A
TRANSSION_PRODUCT_NAME=H8024A
#add KAQHBLES-23 by gaoxuebin 20180206 end
#add XLLLHBLES-9 by gujiacheng 20171201 end

#add XLLLHBLES-48 by gujiacheng 20171201 start
BUILD_GO_GMS=yes
#add XLLLHBLES-48 by gujiacheng 20171201 end

#add CABGHLSS-1 by peixuan.qiu 20171204 start
TRAN_FT_CUSTOM_PERMISSION_SUPPORT = yes
#add CABGHLSS-1 by peixuan.qiu 20171204 end

#RD6 add for KAQHBLES-137 multi md image by xiangfu.dang 20180225 start
TRAN_MODEM_MULTI_MD_IMAGE_SUPPORT = yes
#RD6 add for KAQHBLES-137 multi md image by xiangfu.dang 20180225 end
...
#PPD: add XLLSHLSS-2214 by ruishuang.jia 18/06/20 start
TRAN_PPD_LUCID_DISABLED = no
#PPD: add XLLSHLSS-2214 by ruishuang.jia 18/06/20 end

# add XLLLGOBLES-49 by xing.fang 20171206 start
#modify KAQHBLES-10 by weifeng.niu 20180122 start
#TRAN_DUALSPK_BY_HP = yes
#modify KAQHBLES-10 by weifeng.niu 20180122 end
# add XLLLGOBLES-49 by xing.fang 20171206 end
#add for KA7 FM by yundi begin 20180409
TRAN_FM_SINGLE_SPK=yes
#add for KA7 FM by yundi begin 20180409
#yundi add for KA7 bluetooth speech noise 20180410 start
TRAN_BLUETOOTH_SPEECH_NOISE=yes
#yundi add for KA7 bluetooth speech noise 20180410 end
BUILD_3RDPARTY=yes
#add XLLLHBLES-30 jixiaopan 20180420 start
TRAN_VIRTUAL_GYROSCOPE_ALGORITHM=no
#add XLLLHBLES-30 jixiaopan 20171214 end

#[PPD] ProcessManager hanhao 20171215 start @{
TRAN_PROCMGR_SUPPORT=yes
TRAN_PROCMGR_MODE=deep
TRAN_LMK_BOOST_SUPPORT=yes
#[PPD] ProcessManager hanhao 20171215 end @}

#PPD:add syncHeartBeat switch by yangjian 20180202 start
TRAN_SYNC_GROUP_SUPPORT = yes
#PPD:add syncHeartBeat switch by yangjian 20180202 end

#[PPD] add vm param by peng.zhang 20180202 start
TRAN_VM_STARTSIZE = 16m
TRAN_VM_MINFREE_SIZE = 3m
TRAN_VM_MAXFREE_SIZE = 8m
#[PPD] add vm param by peng.zhang 20180202 end

#[PPD] skip wakelock add by xionghui 2017.12.11 start @{
RLK_REMOVE_WAKELOCK_SUPPORT = yes
#[PPD] add end @}
#Infinix:by gujiacheng 20171216 start
#TECNO:by gaoxuebin 20180201 start
TRAN_OS_TYPE=HIOS
#TECNO:by gaoxuebin 20180201 end
TRAN_OS_LITE=yes
OS_FINGERPRINT_SUPPORT=yes
#TECNO:by gaoxuebin 20180201 start
XLAUNCHER_SUPPORT=no
#TECNO:by gaoxuebin 20180201 end
TAPPING_WAKE_SUPPORT=yes
RLK_MULTI_TOUCH_SUPPORT=yes
#Tecno:by wuhong KAQHBLES-564 20180319 start
TRAN_DISABLE_ADB_RSA_SUPPORT=no
#Tecno:by wuhong KAQHBLES-564 20180319 end
#Infinix:by gujiacheng 20171216 end


#[PPD]add by xingxing.wang for enable f2fs start
TRAN_USE_F2FS = yes
#[PPD]add by xingxing.wang for enable f2fs end

#add by jinbaoping start
RLK_INFINIX_AGINGFUNCTION=yes
#add by jinbaoping end
#Infinix: add dirac by sangui.zhang 20171219 start
#TECNO:yundi add for KA7 start
#INF_DIRAC_SUPPORT = yes
#TECNO:yundi add for KA7 end
#Infinix: add dirac by sangui.zhang 20171219 end
#Infinix:add gujiacheng for XLLLHBLES-271 start
TRANSSION_BUILD_GO=yes
BUILD_GMS=yes
BUILD_AGO_GMS=yes
#Infinix:add gujiacheng for XLLLHBLES-271 end
#infinix add by liuzhiqiang for otg 20171225 start
TRAN_CHARGER_OTG_LPO_SUPPORT = no
#TRAN_CHARGER_SW_OTG_SUPPORT = yes
#infinix add by liuzhiqiang for otg 20171225 end
#Infinix:add for Camera by zhaoheng start
ARCSOFT_BURST_SUPPORT = yes
VISIDON_ASD_SUPPORT = no
RLK_PORTRAIT_MODE_SUPPORT = no
RLK_WATERMARTK_MODE_SUPPORT = no
RLK_AUTO_BRIGHTNESS_SUPPORT = yes
RLK_AUTO_HDR_SUPPORT = no
RLK_TIMESTAMP_SUPPORT = no
RLK_SUPERPHOTO_SUPPORT = no
RLK_SMART_DENOISE_SUPPORT = yes
RLK_FRONT_HDR_SUPPORT = no
OPR_COMMON_DUO_SUPPORT = yes
#Infinix:add for Camera by zhaoheng end
#add for Professional mode by wei.miao@reallytek.com 20180102 start
TRAN_CAMERA_MANUAL_AF_SUPPORT = yes
TRAN_CAMERA_MANUAL_AE_METERING_SUPPORT = yes
TRAN_CAMERA_FRONT_FLASHLIGHT_LEVEL_SUPPORT = yes
#add for Professional mode by wei.miao@reallytek.com 20180102 end
#Tecno:wuhong add for KAQHBLES-798 start
#Infinix:gujiacheng add for XLLLHBLES-549 start
TRANSSION_CLIENT_ID = android-transsion-tecno-rev1
#Infinix:gujiacheng add for XLLLHBLES-549 end
#Tecno:wuhong add for KAQHBLES-798 end
# Infinix: add by haojie.liu for UserGuide 20171129 start
#RD6:fupengcheng modify for KAQHBLES-310 start
RLK_USERGUIDE_OPEN=no
#RD6:fupengcheng modify for KAQHBLES-310 end
RLK_USERGUIDE_VERSION=x606_h8023_c_o
# Infinix: add by haojie.liu for UserGuide 20171129 end

#infinix: add XLLLHBLES-294 zhangjunping for faceid 20180105 start
#TECNO:by gaoxuebin 20180201 start
TRAN_FACEID_SUPPORT = yes
#TECNO:by gaoxuebin 20180201 start
#infinix: add XLLLHBLES-294 zhangjunping for faceid 20180105 end

#Infinix:yuwenyan for XLLLHBLES-1210 20170109 start
TRAN_GMS_FIRST_CERTIFICATION = no
#Infinix:yuwenyan for XLLLHBLES-1210 20170109 end
#Infinix: zhoujinhua for XLLLHBLES-1907 20180117 start
TRAN_SYS_STASL=yes
#Infinix: zhoujinhua for XLLLHBLES-1907 20180117 end
#Infinx:add by caizhaohui for midtest 20180126 start
MIDTEST_OTG_NOT_SUPPORT = yes
#Infinx:add by caizhaohui for midtest 20180126 end

#TECNO CameraAP:add KAQHBLES-907 shiyang.zhang 2018-03-22 start
HIOS_CAMERA_USE_GOOGLE_PHOTOS_SUPPORT = yes
TECNO_CAMERA_NIGHT_SCENE_SUPPORT = yes
#TECNO CameraAP:add KAQHBLES-907 shiyang.zhang 2018-03-22 end

#TECNO CameraAP:add CAMERAEYL-128 shiyang.zhang 2018-01-31 start
TECNO_CAMERA_FRONT_MIRROR = yes
HIOS_CAMERA_AUTO_WATERMARK_SUPPORT = yes
HIOS_CAMERA_ASD_SUPPORT = no
MTK_SLOW_MOTION_VIDEO_SUPPORT = no
MTK_CAMERA_GESTURE_SUPPORT = no
HIOS_CAMERA_FULLSCREEN_SUPPORT = yes
HIOS_CAMERA_SCREENFLASH_SUPPORT = yes
TECNO_CAMERA_PORTRAITURE_SUPPORT = yes
TECNO_CAMERA_SUPER_PIXEL_SUPPORT = no
TECNO_CAMERA_SHOT2SHOT_SUPPORT = no
HIOS_CAMERA_FILTER_SUPPORT = no
TECNO_CAMERA_CONTINUOUSSHOT_SUPPORT = no
HIOS_CAMERA_DEBUG_SUPPORT = yes
#TECNO CameraAP:add CAMERAEYL-128 shiyang.zhang 2018-01-31 end

#TECNO CameraAP:KAQHBLES-341 yingmin.huang 20180306 start
#TECNO CameraAP:CAMERAEYL-195 shiyang.zhang 20180427 start remove screenflash default value
#HIOS_CAMERA_SCREENFLASH_DEF_ON = yes
#TECNO CameraAP:CAMERAEYL-195 shiyang.zhang 20180427 end, remove screenflash default value
#TECNO CameraAP:KAQHBLES-341 yingmin.huang 20180306 end

#add KAQHBLES-23 by gaoxuebin 20180206 start
TRANSSION_WHATSAPP_SUPPORT = yes
#add KAQHBLES-23 by gaoxuebin 20180206 end
#add KAQHBLES-23 by gaoxuebin 20180209 start
OS_STATUSBAR_ROAMING_SUPPORT = yes
#add KAQHBLES-23 by gaoxuebin 20180209 end
#add KAQHBLES-84 by gaoxuebin 20180225 start
RLK_RLKOOBE_SUPPORT = yes
#add KAQHBLES-84 by gaoxuebin 20180225 end

#RD6:add KAQHBLES-23 by fupengcheng 20180227 start
OS_AUTOLOG_RELEASE_VERSION = no
OS_BACKUP_AND_RESTORE_SUPPORT := yes
XOS_SYSTEMUI_SUPPORT = no
#RD6:add KAQHBLES-23 by gaoxuebin 20180308 start
OS_SOS_SUPPORT = no
#RD6:add KAQHBLES-23 by gaoxuebin 20180308 end
OS_NOTEBOOK_SUPPORT := yes
OS_NOTEBOOK_N_TO_O_SUPPORT ?= no
#RD6:modify fupengcheng for manufacturer 20180306 start
TRANSSION_PRODUCT_MANUFACTURER = TECNO MOBILE LIMITED
#RD6:modify fupengcheng for manufacturer 20180306 end
#RD6:add KAQHBLES-23 by fupengcheng 20180227 end
#RD6:bin.zhang add for KAQHBLES-114 20180302 start
TRAN_LAUNCHER_CONFIG = KA7
#RD6:bin.zhang add for KAQHBLES-114 20180302 end
#RD6:add KAQHBLES-105 by maxiongyue 20180301 start
TRANSSION_CALENDARGOOGLE_UNINSTALL_SUPPORT = yes
#RD6:add KAQHBLES-105 by maxiongyue 20180301 end
#add KAQHBLES-21 by yileizhao 20180302 start
MIDTEST_SINGLE_LIGHT_SUPPORTED = yes
#add KAQHBLES-21 by yileizhao 20180302 end

#RD6:wanglefei add screen Snapshot 20180312 start
RLK_CAMERA_SCREEN_SNAPSHOT = yes
#RD6:wanglefei add screen Snapshot 20180312 end

# add KAQHBLES-10 by weifeng.niu 20180308 start
TRAN_SEC_FILE_COPY_SUPPORT = yes
# add KAQHBLES-10 by weifeng.niu 20180308 end

#RD6:add KAQHBLES-25  by gaoxuebin 20180304 start
RLK_BJOOBE_SUPPORT = yes
#RD6:add KAQHBLES-25  by gaoxuebin 20180305 end

#TECNO CameraAP:add KAQHBLES-826 shiyang.zhang 2018-04-11 start
HIOS_CAMERA_FRONT_PHOTO_FLASH_ON_SUPPORT = yes
HIOS_CAMERA_FRONT_VIDEO_FLASH_AUTO_NO_SUPPORT = yes
#TECNO CameraAP:add KAQHBLES-826 shiyang.zhang 2018-04-11 end

#TECNO CameraAP:add KAQHBLES-1624 shiyang.zhang 2018-04-17 start
HIOS_CAMERA_PHOTO_HDR_ANIMATION_SUPPORT = yes
#TECNO CameraAP:add KAQHBLES-1624 shiyang.zhang 2018-04-17 end

#Tecno add liushuang 20180314 start
OS_INADVERTENT_SUPPORT = yes
#Tecno add liushuang 20180314 end
#RD6:add KAQHBLES-915  by gaoxuebin 20180321 start
OS_MULTI_WINDOW_SUPPORT = no
#RD6:add KAQHBLES-915  by gaoxuebin 20180321 end

#Tecno add liushuang 20180402 start
OS_CHARGING_ANIMATION_SUPPORT = no
#Tecno add liushuang 20180402 end
#Tecno add shixuemei 20180417 start
OS_PILING_SUPPORT = no
#Tecno add shixuemei 20180417 end

#RD6:wangmeng modify for KAQHBLES-1767 2018-04-19 start
TRAN_RCS_SUPPORT = yes
#RD6:wangmeng modify for KAQHBLES-1767 2018-04-19 end

#RD6:wuhong modify for KAQHBLES-2034 2018-05-09 start
TRAN_GMSEXPRESS_SUPPORT = yes
#RD6:wuhong modify for KAQHBLES-2034 2018-05-09 end
#SID: Added for KAQHBLES-2312 by longlong.li 20180712 start
#TRAN_BOOMPLAY_GO_SUPPORT = yes
TRAN_BOOMPLAYER_UNINSTALL_SUPPORT = yes
TRAN_TOUCHPAL_SUPPORT = yes
TRAN_SPORTYBET_SUPPORT = yes
#SID: Added for KAQHBLES-2312 by longlong.li 20180712 end
